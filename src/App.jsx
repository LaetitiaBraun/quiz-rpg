...
export default function App() {
  ...
  return (
    <div className="app-shell" style={{ minHeight: '100vh', background: 'var(--bg-gradient)' }}>
      ...
      {showProfile && (
        <div className="app-shell" style={{ position: 'fixed', inset: 0, zIndex: 500, overflowY: 'auto', overflowX: 'hidden', maxWidth: '100vw', background: 'var(--bg-gradient)' }}>
          <ProfileScreen
            character={character}
